...
public:
	...
	class UObject*                                __WorldContext;                                    // 0x0018(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FSCharacterFightInfo                   OutInfo;                                           // 0x0020(0x0210)(Parm, OutParm, HasGetValueTypeHash)
	bool                                          OutIsFound;                                        // 0x0230(0x0001)(Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_231[0x3];                                      // 0x0231(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	class FName                                   CallFunc_Conv_StringToName_ReturnValue;            // 0x0234(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FSCharacterFightInfo                   CallFunc_GetDataTableRowFromName_OutRow;           // 0x0240(0x0210)(HasGetValueTypeHash)
...
static_assert(sizeof(DataTableUtil_C_LoadCharacterFightInfo) == 0x000458, "Wrong size on DataTableUtil_C_LoadCharacterFightInfo");
...
static_assert(offsetof(DataTableUtil_C_LoadCharacterFightInfo, OutIsFound) == 0x000230, "Member 'DataTableUtil_C_LoadCharacterFightInfo::OutIsFound' has a wrong offset!");
static_assert(offsetof(DataTableUtil_C_LoadCharacterFightInfo, CallFunc_Conv_StringToName_ReturnValue) == 0x000234, "Member 'DataTableUtil_C_LoadCharacterFightInfo::CallFunc_Conv_StringToName_ReturnValue' has a wrong offset!");
static_assert(offsetof(DataTableUtil_C_LoadCharacterFightInfo, CallFunc_GetDataTableRowFromName_OutRow) == 0x000240, "Member 'DataTableUtil_C_LoadCharacterFightInfo::CallFunc_GetDataTableRowFromName_OutRow' has a wrong offset!");
static_assert(offsetof(DataTableUtil_C_LoadCharacterFightInfo, CallFunc_GetDataTableRowFromName_ReturnValue) == 0x000450, "Member 'DataTableUtil_C_LoadCharacterFightInfo::CallFunc_GetDataTableRowFromName_ReturnValue' has a wrong offset!");
