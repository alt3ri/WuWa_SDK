...
namespace Offsets
{
	constexpr int32 GObjects          = 0x08486608;
	constexpr int32 AppendString      = 0x02941570;
	constexpr int32 GNames            = 0x08429BC0;
	constexpr int32 GWorld            = 0x083450B0;
	constexpr int32 ProcessEvent      = 0x02B4A9C0;
