...
public:
	...
	struct FSSkillBehaviorUpdateCustomValue       UpdateCustomValue_257_8F128846455436A6E50D79874DF0F5EE; // 0x0268(0x0010)(Edit, BlueprintVisible, HasGetValueTypeHash)
	TSoftObjectPtr<class UPrimaryDataAsset>       CommonConf_268_DCE4CA4341FC32509C5E399C236F59F6;   // 0x0278(0x0030)(Edit, BlueprintVisible, HasGetValueTypeHash)
};
static_assert(alignof(FSSkillBehaviorAction) == 0x000008, "Wrong alignment on FSSkillBehaviorAction");
static_assert(sizeof(FSSkillBehaviorAction) == 0x0002A8, "Wrong size on FSSkillBehaviorAction");
...
static_assert(offsetof(FSSkillBehaviorAction, UpdateCustomValue_257_8F128846455436A6E50D79874DF0F5EE) == 0x000268, "Member 'FSSkillBehaviorAction::UpdateCustomValue_257_8F128846455436A6E50D79874DF0F5EE' has a wrong offset!");
static_assert(offsetof(FSSkillBehaviorAction, CommonConf_268_DCE4CA4341FC32509C5E399C236F59F6) == 0x000278, "Member 'FSSkillBehaviorAction::CommonConf_268_DCE4CA4341FC32509C5E399C236F59F6' has a wrong offset!");
