...
// TDelegate<void(const class FName& Category, const int32 Verbosity, const class FString& Format, const class FString& Message)>InLogDelegate                                          (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, NativeAccessSpecifierPublic)
