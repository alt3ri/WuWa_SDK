...
public:
	...
	TDelegate<void(bool Result, class UTraceBaseElement* Element, double Frame, double Index_0)> Delegate; // 0x0018(0x0028)(ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, NativeAccessSpecifierPublic)
