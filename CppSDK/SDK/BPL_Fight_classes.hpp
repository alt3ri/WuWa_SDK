...
public:
	...
	static void __Actorh_P__(class AActor* Actor, float _l, float __, float ___0, class UObject* __WorldContext, struct FVectorDouble* P__);
	static bool ___K(class UObject* Context, const struct FVectorDouble& Start, const struct FVectorDouble& End, ETraceTypeQuery TraceChannel, bool bTraceComplex, EDrawDebugTrace DrawDebugType, bool bIgnoreSelf, const struct FLinearColor& TraceColor, const struct FLinearColor& TraceHitColor, float DrawTime, class UObject* __WorldContext, struct FHitResult* OutHit);
	...
	static void ____h_P__(const struct FRotator& ___l, const struct FVectorDouble& __P_, float _l, float __, float ___0, class UObject* __WorldContext, struct FVectorDouble* P__);
