...
public:
	...
	int32                                         K2Node_Event_Handle;                               // 0x0004(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class UAkComponent*                           K2Node_DynamicCast_AsAk_Component;                 // 0x0020(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          K2Node_DynamicCast_bSuccess;                       // 0x0028(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          K2Node_Event_bValue;                               // 0x0029(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          CallFunc_Stop_ReturnValue;                         // 0x002A(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          CallFunc_EffectHandleIsValid_ReturnValue_1;        // 0x002B(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          CallFunc_EffectHandleIsValid_ReturnValue_2;        // 0x002C(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          CallFunc_EffectHandleIsValid_ReturnValue_3;        // 0x002D(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	class UKuroVirtualAttachmentChildComponent*   K2Node_DynamicCast_AsKuro_Virtual_Attachment_Child_Component; // 0x0050(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	EKuroFeatureLevel                             CallFunc_GetWorldFeatureLevel_ReturnValue;         // 0x007D(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_EqualEqual_ByteByte_ReturnValue;          // 0x007E(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          CallFunc_IsVisible_ReturnValue;                    // 0x007F(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	bool                                          CallFunc_Stop_ReturnValue_1;                       // 0x008C(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          CallFunc_EffectHandleIsValid_ReturnValue_4;        // 0x008D(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
};
...
static_assert(sizeof(BP_EffectActor_C_ExecuteUbergraph_BP_EffectActor) == 0x000090, "Wrong size on BP_EffectActor_C_ExecuteUbergraph_BP_EffectActor");
...
static_assert(offsetof(BP_EffectActor_C_ExecuteUbergraph_BP_EffectActor, K2Node_Event_Handle) == 0x000004, "Member 'BP_EffectActor_C_ExecuteUbergraph_BP_EffectActor::K2Node_Event_Handle' has a wrong offset!");
static_assert(offsetof(BP_EffectActor_C_ExecuteUbergraph_BP_EffectActor, K2Node_Event_EndPlayReason) == 0x000008, "Member 'BP_EffectActor_C_ExecuteUbergraph_BP_EffectActor::K2Node_Event_EndPlayReason' has a wrong offset!");
...
static_assert(offsetof(BP_EffectActor_C_ExecuteUbergraph_BP_EffectActor, ___int_Array_Index_Variable) == 0x000014, "Member 'BP_EffectActor_C_ExecuteUbergraph_BP_EffectActor::___int_Array_Index_Variable' has a wrong offset!");
...
static_assert(offsetof(BP_EffectActor_C_ExecuteUbergraph_BP_EffectActor, K2Node_DynamicCast_AsAk_Component) == 0x000020, "Member 'BP_EffectActor_C_ExecuteUbergraph_BP_EffectActor::K2Node_DynamicCast_AsAk_Component' has a wrong offset!");
static_assert(offsetof(BP_EffectActor_C_ExecuteUbergraph_BP_EffectActor, K2Node_DynamicCast_bSuccess) == 0x000028, "Member 'BP_EffectActor_C_ExecuteUbergraph_BP_EffectActor::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(BP_EffectActor_C_ExecuteUbergraph_BP_EffectActor, K2Node_Event_bValue) == 0x000029, "Member 'BP_EffectActor_C_ExecuteUbergraph_BP_EffectActor::K2Node_Event_bValue' has a wrong offset!");
static_assert(offsetof(BP_EffectActor_C_ExecuteUbergraph_BP_EffectActor, CallFunc_Stop_ReturnValue) == 0x00002A, "Member 'BP_EffectActor_C_ExecuteUbergraph_BP_EffectActor::CallFunc_Stop_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_EffectActor_C_ExecuteUbergraph_BP_EffectActor, CallFunc_EffectHandleIsValid_ReturnValue_1) == 0x00002B, "Member 'BP_EffectActor_C_ExecuteUbergraph_BP_EffectActor::CallFunc_EffectHandleIsValid_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_EffectActor_C_ExecuteUbergraph_BP_EffectActor, CallFunc_EffectHandleIsValid_ReturnValue_2) == 0x00002C, "Member 'BP_EffectActor_C_ExecuteUbergraph_BP_EffectActor::CallFunc_EffectHandleIsValid_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(BP_EffectActor_C_ExecuteUbergraph_BP_EffectActor, CallFunc_EffectHandleIsValid_ReturnValue_3) == 0x00002D, "Member 'BP_EffectActor_C_ExecuteUbergraph_BP_EffectActor::CallFunc_EffectHandleIsValid_ReturnValue_3' has a wrong offset!");
static_assert(offsetof(BP_EffectActor_C_ExecuteUbergraph_BP_EffectActor, CallFunc_K2_GetRootComponent_ReturnValue_1) == 0x000030, "Member 'BP_EffectActor_C_ExecuteUbergraph_BP_EffectActor::CallFunc_K2_GetRootComponent_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_EffectActor_C_ExecuteUbergraph_BP_EffectActor, CallFunc_GetChildrenComponents_Children) == 0x000038, "Member 'BP_EffectActor_C_ExecuteUbergraph_BP_EffectActor::CallFunc_GetChildrenComponents_Children' has a wrong offset!");
static_assert(offsetof(BP_EffectActor_C_ExecuteUbergraph_BP_EffectActor, CallFunc_Array_Get_Item) == 0x000048, "Member 'BP_EffectActor_C_ExecuteUbergraph_BP_EffectActor::CallFunc_Array_Get_Item' has a wrong offset!");
static_assert(offsetof(BP_EffectActor_C_ExecuteUbergraph_BP_EffectActor, K2Node_DynamicCast_AsKuro_Virtual_Attachment_Child_Component) == 0x000050, "Member 'BP_EffectActor_C_ExecuteUbergraph_BP_EffectActor::K2Node_DynamicCast_AsKuro_Virtual_Attachment_Child_Component' has a wrong offset!");
static_assert(offsetof(BP_EffectActor_C_ExecuteUbergraph_BP_EffectActor, K2Node_DynamicCast_bSuccess_1) == 0x000058, "Member 'BP_EffectActor_C_ExecuteUbergraph_BP_EffectActor::K2Node_DynamicCast_bSuccess_1' has a wrong offset!");
...
static_assert(offsetof(BP_EffectActor_C_ExecuteUbergraph_BP_EffectActor, K2Node_DynamicCast_bSuccess_2) == 0x000068, "Member 'BP_EffectActor_C_ExecuteUbergraph_BP_EffectActor::K2Node_DynamicCast_bSuccess_2' has a wrong offset!");
static_assert(offsetof(BP_EffectActor_C_ExecuteUbergraph_BP_EffectActor, CallFunc_GetOwner_ReturnValue) == 0x000070, "Member 'BP_EffectActor_C_ExecuteUbergraph_BP_EffectActor::CallFunc_GetOwner_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_EffectActor_C_ExecuteUbergraph_BP_EffectActor, CallFunc_Array_Length_ReturnValue) == 0x000078, "Member 'BP_EffectActor_C_ExecuteUbergraph_BP_EffectActor::CallFunc_Array_Length_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_EffectActor_C_ExecuteUbergraph_BP_EffectActor, CallFunc_EqualEqual_ObjectObject_ReturnValue) == 0x00007C, "Member 'BP_EffectActor_C_ExecuteUbergraph_BP_EffectActor::CallFunc_EqualEqual_ObjectObject_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_EffectActor_C_ExecuteUbergraph_BP_EffectActor, CallFunc_GetWorldFeatureLevel_ReturnValue) == 0x00007D, "Member 'BP_EffectActor_C_ExecuteUbergraph_BP_EffectActor::CallFunc_GetWorldFeatureLevel_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_EffectActor_C_ExecuteUbergraph_BP_EffectActor, CallFunc_EqualEqual_ByteByte_ReturnValue) == 0x00007E, "Member 'BP_EffectActor_C_ExecuteUbergraph_BP_EffectActor::CallFunc_EqualEqual_ByteByte_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_EffectActor_C_ExecuteUbergraph_BP_EffectActor, CallFunc_IsVisible_ReturnValue) == 0x00007F, "Member 'BP_EffectActor_C_ExecuteUbergraph_BP_EffectActor::CallFunc_IsVisible_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_EffectActor_C_ExecuteUbergraph_BP_EffectActor, ___int_Loop_Counter_Variable) == 0x000080, "Member 'BP_EffectActor_C_ExecuteUbergraph_BP_EffectActor::___int_Loop_Counter_Variable' has a wrong offset!");
static_assert(offsetof(BP_EffectActor_C_ExecuteUbergraph_BP_EffectActor, CallFunc_Less_IntInt_ReturnValue) == 0x000084, "Member 'BP_EffectActor_C_ExecuteUbergraph_BP_EffectActor::CallFunc_Less_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_EffectActor_C_ExecuteUbergraph_BP_EffectActor, CallFunc_Add_IntInt_ReturnValue) == 0x000088, "Member 'BP_EffectActor_C_ExecuteUbergraph_BP_EffectActor::CallFunc_Add_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_EffectActor_C_ExecuteUbergraph_BP_EffectActor, CallFunc_Stop_ReturnValue_1) == 0x00008C, "Member 'BP_EffectActor_C_ExecuteUbergraph_BP_EffectActor::CallFunc_Stop_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_EffectActor_C_ExecuteUbergraph_BP_EffectActor, CallFunc_EffectHandleIsValid_ReturnValue_4) == 0x00008D, "Member 'BP_EffectActor_C_ExecuteUbergraph_BP_EffectActor::CallFunc_EffectHandleIsValid_ReturnValue_4' has a wrong offset!");
