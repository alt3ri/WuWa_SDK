...
public:
	...
	bool                                          CallFunc_IsUsingNotSeparateCache_ReturnValue;      // 0x0008(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          CallFunc_IsUsingParallaxCorrect_ReturnValue;       // 0x0009(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_A[0x2];                                        // 0x000A(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	struct FHitResult                             CallFunc_K2_SetRelativeRotation_SweepHitResult;    // 0x000C(0x0094)(IsPlainOldData, NoDestructor, ContainsInstancedReference)
	...
	struct FRotator                               CallFunc_CalLightDirectionWithLimit_LightRotation; // 0x00A8(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor)
	struct FRotator                               CallFunc_CalLightDirectionWithLimit_LightRotation_1; // 0x00B4(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	struct FVector                                CallFunc_GetParallaxCorrectCachedForwardVector_ReturnValue; // 0x00C8(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	bool                                          CallFunc_LessEqual_FloatFloat_ReturnValue;         // 0x01B5(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
...
static_assert(sizeof(BP_GlobalGI_C_Update_Light_Direction) == 0x000254, "Wrong size on BP_GlobalGI_C_Update_Light_Direction");
static_assert(offsetof(BP_GlobalGI_C_Update_Light_Direction, CallFunc_IsValid_ReturnValue) == 0x000000, "Member 'BP_GlobalGI_C_Update_Light_Direction::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_GlobalGI_C_Update_Light_Direction, CallFunc_Subtract_FloatFloat_ReturnValue) == 0x000004, "Member 'BP_GlobalGI_C_Update_Light_Direction::CallFunc_Subtract_FloatFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_GlobalGI_C_Update_Light_Direction, CallFunc_IsUsingNotSeparateCache_ReturnValue) == 0x000008, "Member 'BP_GlobalGI_C_Update_Light_Direction::CallFunc_IsUsingNotSeparateCache_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_GlobalGI_C_Update_Light_Direction, CallFunc_IsUsingParallaxCorrect_ReturnValue) == 0x000009, "Member 'BP_GlobalGI_C_Update_Light_Direction::CallFunc_IsUsingParallaxCorrect_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_GlobalGI_C_Update_Light_Direction, CallFunc_K2_SetRelativeRotation_SweepHitResult) == 0x00000C, "Member 'BP_GlobalGI_C_Update_Light_Direction::CallFunc_K2_SetRelativeRotation_SweepHitResult' has a wrong offset!");
static_assert(offsetof(BP_GlobalGI_C_Update_Light_Direction, CallFunc_Multiply_FloatFloat_ReturnValue) == 0x0000A0, "Member 'BP_GlobalGI_C_Update_Light_Direction::CallFunc_Multiply_FloatFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_GlobalGI_C_Update_Light_Direction, CallFunc_Add_FloatFloat_ReturnValue) == 0x0000A4, "Member 'BP_GlobalGI_C_Update_Light_Direction::CallFunc_Add_FloatFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_GlobalGI_C_Update_Light_Direction, CallFunc_CalLightDirectionWithLimit_LightRotation) == 0x0000A8, "Member 'BP_GlobalGI_C_Update_Light_Direction::CallFunc_CalLightDirectionWithLimit_LightRotation' has a wrong offset!");
static_assert(offsetof(BP_GlobalGI_C_Update_Light_Direction, CallFunc_CalLightDirectionWithLimit_LightRotation_1) == 0x0000B4, "Member 'BP_GlobalGI_C_Update_Light_Direction::CallFunc_CalLightDirectionWithLimit_LightRotation_1' has a wrong offset!");
static_assert(offsetof(BP_GlobalGI_C_Update_Light_Direction, CallFunc_Subtract_FloatFloat_ReturnValue_1) == 0x0000C0, "Member 'BP_GlobalGI_C_Update_Light_Direction::CallFunc_Subtract_FloatFloat_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_GlobalGI_C_Update_Light_Direction, CallFunc_Divide_FloatFloat_ReturnValue) == 0x0000C4, "Member 'BP_GlobalGI_C_Update_Light_Direction::CallFunc_Divide_FloatFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_GlobalGI_C_Update_Light_Direction, CallFunc_GetParallaxCorrectCachedForwardVector_ReturnValue) == 0x0000C8, "Member 'BP_GlobalGI_C_Update_Light_Direction::CallFunc_GetParallaxCorrectCachedForwardVector_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_GlobalGI_C_Update_Light_Direction, CallFunc_Divide_FloatFloat_ReturnValue_1) == 0x0000D4, "Member 'BP_GlobalGI_C_Update_Light_Direction::CallFunc_Divide_FloatFloat_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_GlobalGI_C_Update_Light_Direction, CallFunc_Multiply_FloatFloat_ReturnValue_1) == 0x0000D8, "Member 'BP_GlobalGI_C_Update_Light_Direction::CallFunc_Multiply_FloatFloat_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_GlobalGI_C_Update_Light_Direction, CallFunc_Multiply_FloatFloat_ReturnValue_2) == 0x0000DC, "Member 'BP_GlobalGI_C_Update_Light_Direction::CallFunc_Multiply_FloatFloat_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(BP_GlobalGI_C_Update_Light_Direction, CallFunc_Multiply_FloatFloat_ReturnValue_3) == 0x0000E0, "Member 'BP_GlobalGI_C_Update_Light_Direction::CallFunc_Multiply_FloatFloat_ReturnValue_3' has a wrong offset!");
static_assert(offsetof(BP_GlobalGI_C_Update_Light_Direction, CallFunc_GetForwardVector_ReturnValue) == 0x0000E4, "Member 'BP_GlobalGI_C_Update_Light_Direction::CallFunc_GetForwardVector_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(BP_GlobalGI_C_Update_Light_Direction, CallFunc_Dot_VectorVector_ReturnValue) == 0x000184, "Member 'BP_GlobalGI_C_Update_Light_Direction::CallFunc_Dot_VectorVector_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_GlobalGI_C_Update_Light_Direction, CallFunc_Multiply_FloatFloat_ReturnValue_4) == 0x000188, "Member 'BP_GlobalGI_C_Update_Light_Direction::CallFunc_Multiply_FloatFloat_ReturnValue_4' has a wrong offset!");
static_assert(offsetof(BP_GlobalGI_C_Update_Light_Direction, CallFunc_DegAcos_ReturnValue) == 0x00018C, "Member 'BP_GlobalGI_C_Update_Light_Direction::CallFunc_DegAcos_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_GlobalGI_C_Update_Light_Direction, CallFunc_GreaterEqual_FloatFloat_ReturnValue) == 0x000190, "Member 'BP_GlobalGI_C_Update_Light_Direction::CallFunc_GreaterEqual_FloatFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_GlobalGI_C_Update_Light_Direction, CallFunc_IsUsingParallaxCorrect_ReturnValue_1) == 0x000191, "Member 'BP_GlobalGI_C_Update_Light_Direction::CallFunc_IsUsingParallaxCorrect_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_GlobalGI_C_Update_Light_Direction, CallFunc_GetForwardVector_ReturnValue_1) == 0x000194, "Member 'BP_GlobalGI_C_Update_Light_Direction::CallFunc_GetForwardVector_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_GlobalGI_C_Update_Light_Direction, CallFunc_GetForwardVector_ReturnValue_2) == 0x0001A0, "Member 'BP_GlobalGI_C_Update_Light_Direction::CallFunc_GetForwardVector_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(BP_GlobalGI_C_Update_Light_Direction, CallFunc_Dot_VectorVector_ReturnValue_1) == 0x0001AC, "Member 'BP_GlobalGI_C_Update_Light_Direction::CallFunc_Dot_VectorVector_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_GlobalGI_C_Update_Light_Direction, CallFunc_DegAcos_ReturnValue_1) == 0x0001B0, "Member 'BP_GlobalGI_C_Update_Light_Direction::CallFunc_DegAcos_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_GlobalGI_C_Update_Light_Direction, CallFunc_GreaterEqual_FloatFloat_ReturnValue_1) == 0x0001B4, "Member 'BP_GlobalGI_C_Update_Light_Direction::CallFunc_GreaterEqual_FloatFloat_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_GlobalGI_C_Update_Light_Direction, CallFunc_LessEqual_FloatFloat_ReturnValue) == 0x0001B5, "Member 'BP_GlobalGI_C_Update_Light_Direction::CallFunc_LessEqual_FloatFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_GlobalGI_C_Update_Light_Direction, CallFunc_Add_FloatFloat_ReturnValue_1) == 0x0001B8, "Member 'BP_GlobalGI_C_Update_Light_Direction::CallFunc_Add_FloatFloat_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_GlobalGI_C_Update_Light_Direction, CallFunc_GreaterEqual_FloatFloat_ReturnValue_2) == 0x0001BC, "Member 'BP_GlobalGI_C_Update_Light_Direction::CallFunc_GreaterEqual_FloatFloat_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(BP_GlobalGI_C_Update_Light_Direction, CallFunc_K2_SetRelativeRotation_SweepHitResult_2) == 0x0001C0, "Member 'BP_GlobalGI_C_Update_Light_Direction::CallFunc_K2_SetRelativeRotation_SweepHitResult_2' has a wrong offset!");
...
{
public:
	bool                                          CallFunc_GetLumenDiffuseGIFeatureEnabled_ReturnValue; // 0x0000(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
...
static_assert(offsetof(BP_GlobalGI_C_OnGlobalGITick, CallFunc_GetLumenDiffuseGIFeatureEnabled_ReturnValue) == 0x000000, "Member 'BP_GlobalGI_C_OnGlobalGITick::CallFunc_GetLumenDiffuseGIFeatureEnabled_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_GlobalGI_C_OnGlobalGITick, CallFunc_Not_PreBool_ReturnValue) == 0x000001, "Member 'BP_GlobalGI_C_OnGlobalGITick::CallFunc_Not_PreBool_ReturnValue' has a wrong offset!");
