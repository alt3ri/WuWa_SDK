...
static_assert(sizeof(UARTexture) == 0x000130, "Wrong size on UARTexture");
static_assert(offsetof(UARTexture, TextureType) == 0x000110, "Member 'UARTexture::TextureType' has a wrong offset!");
static_assert(offsetof(UARTexture, Timestamp) == 0x000114, "Member 'UARTexture::Timestamp' has a wrong offset!");
static_assert(offsetof(UARTexture, ExternalTextureGuid) == 0x000118, "Member 'UARTexture::ExternalTextureGuid' has a wrong offset!");
static_assert(offsetof(UARTexture, Size) == 0x000128, "Member 'UARTexture::Size' has a wrong offset!");
...
static_assert(sizeof(UARTextureCameraImage) == 0x000130, "Wrong size on UARTextureCameraImage");
...
{
public:
	EARDepthQuality                               DepthQuality;                                      // 0x0130(0x0001)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EARDepthAccuracy                              DepthAccuracy;                                     // 0x0131(0x0001)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bIsTemporallySmoothed;                             // 0x0132(0x0001)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UARTextureCameraDepth) == 0x000138, "Wrong size on UARTextureCameraDepth");
static_assert(offsetof(UARTextureCameraDepth, DepthQuality) == 0x000130, "Member 'UARTextureCameraDepth::DepthQuality' has a wrong offset!");
static_assert(offsetof(UARTextureCameraDepth, DepthAccuracy) == 0x000131, "Member 'UARTextureCameraDepth::DepthAccuracy' has a wrong offset!");
static_assert(offsetof(UARTextureCameraDepth, bIsTemporallySmoothed) == 0x000132, "Member 'UARTextureCameraDepth::bIsTemporallySmoothed' has a wrong offset!");
...
static_assert(offsetof(UAREnvironmentCaptureProbeTexture, TextureType) == 0x000168, "Member 'UAREnvironmentCaptureProbeTexture::TextureType' has a wrong offset!");
static_assert(offsetof(UAREnvironmentCaptureProbeTexture, Timestamp) == 0x00016C, "Member 'UAREnvironmentCaptureProbeTexture::Timestamp' has a wrong offset!");
static_assert(offsetof(UAREnvironmentCaptureProbeTexture, ExternalTextureGuid) == 0x000170, "Member 'UAREnvironmentCaptureProbeTexture::ExternalTextureGuid' has a wrong offset!");
static_assert(offsetof(UAREnvironmentCaptureProbeTexture, Size) == 0x000180, "Member 'UAREnvironmentCaptureProbeTexture::Size' has a wrong offset!");
