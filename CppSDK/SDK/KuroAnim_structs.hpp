...
public:
	...
	EKuroHumanIKMode                              Mode;                                              // 0x00F9(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(FAnimNode_KuroHumanIK, bEnabled) == 0x0000F8, "Member 'FAnimNode_KuroHumanIK::bEnabled' has a wrong offset!");
static_assert(offsetof(FAnimNode_KuroHumanIK, Mode) == 0x0000F9, "Member 'FAnimNode_KuroHumanIK::Mode' has a wrong offset!");
