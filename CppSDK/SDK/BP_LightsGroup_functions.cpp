...
int32 ABP_LightsGroup_C::GetPlacementSortOrder() const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_LightsGroup_C", "GetPlacementSortOrder");

	Params::BP_LightsGroup_C_GetPlacementSortOrder Parms{};
