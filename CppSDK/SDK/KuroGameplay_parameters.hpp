...
public:
	...
	TDelegate<void(TSubclassOf<class AActor> Class_0, const struct FTransformDouble& Transform)> InActorSystem_Get; // 0x0208(0x0028)(ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, NativeAccessSpecifierPublic)
