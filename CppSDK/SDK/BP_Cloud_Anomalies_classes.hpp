...
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame_BP_Cloud_Anomalies_C;               // 0x05A8(0x0008)(ZeroConstructor, Transient, DuplicateTransient)
	class UStaticMeshComponent*                   Cloud_Anomalies;                                   // 0x05B0(0x0008)(BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash)
