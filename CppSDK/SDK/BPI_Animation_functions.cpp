...
void IBPI_Animation_C::InterfaceControlPoint(const struct FVector& Offset)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("BPI_Animation_C", "InterfaceControlPoint");

	Params::BPI_Animation_C_InterfaceControlPoint Parms{};
