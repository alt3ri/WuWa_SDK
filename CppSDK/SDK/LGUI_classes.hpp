...
public:
	...
	TDelegate<void(const class FString& HyperLink)> OnHyperLinkClickCallBack;                          // 0x0860(0x0028)(Edit, ZeroConstructor, InstancedReference, NativeAccessSpecifierPublic)
	uint8                                         Pad_888[0x80];                                     // 0x0888(0x0080)(Fixing Size After Last Property [ Dumper-7 ])
	bool                                          bEnableTextRenderSystemV2;                         // 0x0908(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_909[0x117];                                    // 0x0909(0x0117)(Fixing Size After Last Property [ Dumper-7 ])
	class UUITextClickComponent*                  ClickComponent;                                    // 0x0A20(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_A28[0x28];                                     // 0x0A28(0x0028)(Fixing Size After Last Property [ Dumper-7 ])
	TDelegate<void()>                             OnSelfLanguageChange;                              // 0x0A50(0x0028)(Edit, ZeroConstructor, DisableEditOnInstance, EditConst, InstancedReference, NativeAccessSpecifierPublic)
	TDelegate<void()>                             OnTextureAsyncLoaded;                              // 0x0A78(0x0028)(Edit, ZeroConstructor, DisableEditOnInstance, EditConst, InstancedReference, NativeAccessSpecifierPublic)
	uint32                                        TranslateId;                                       // 0x0AA0(0x0004)(Edit, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_AA4[0x24];                                     // 0x0AA4(0x0024)(Fixing Size After Last Property [ Dumper-7 ])
	bool                                          bGameRichText;                                     // 0x0AC8(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UUIText) == 0x000AD0, "Wrong size on UUIText");
...
static_assert(offsetof(UUIText, OnHyperLinkClickCallBack) == 0x000860, "Member 'UUIText::OnHyperLinkClickCallBack' has a wrong offset!");
static_assert(offsetof(UUIText, bEnableTextRenderSystemV2) == 0x000908, "Member 'UUIText::bEnableTextRenderSystemV2' has a wrong offset!");
static_assert(offsetof(UUIText, ClickComponent) == 0x000A20, "Member 'UUIText::ClickComponent' has a wrong offset!");
static_assert(offsetof(UUIText, OnSelfLanguageChange) == 0x000A50, "Member 'UUIText::OnSelfLanguageChange' has a wrong offset!");
static_assert(offsetof(UUIText, OnTextureAsyncLoaded) == 0x000A78, "Member 'UUIText::OnTextureAsyncLoaded' has a wrong offset!");
static_assert(offsetof(UUIText, TranslateId) == 0x000AA0, "Member 'UUIText::TranslateId' has a wrong offset!");
static_assert(offsetof(UUIText, bGameRichText) == 0x000AC8, "Member 'UUIText::bGameRichText' has a wrong offset!");
...
static_assert(sizeof(UUICustomMesh) == 0x0007D0, "Wrong size on UUICustomMesh");
...
public:
	uint8                                         Pad_3F8[0x10];                                     // 0x03F8(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	FMulticastInlineDelegateProperty_             OnStateChange;                                     // 0x0408(0x0010)(Edit, ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	...
	FMulticastInlineDelegateProperty_             OnHover;                                           // 0x0450(0x0010)(Edit, ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnUnHover;                                         // 0x0460(0x0010)(Edit, ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnUndeterminedClicked;                             // 0x0470(0x0010)(Edit, ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
