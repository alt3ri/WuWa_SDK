...
public:
	...
	static void _____Int(class ABaseCharacter* _r, const class FString& Key, class UObject* __WorldContext, int32* _);
	...
	static void __Current___(class ABaseCharacter* __, int32 __id, class UObject* __WorldContext, float* ___);
