...
public:
	...
	TMap<int32, float>                            ____CueId;                                         // 0x0248(0x0050)(Edit, BlueprintVisible, DisableEditOnInstance)
...
static_assert(offsetof(UBP_TeleControlConfig_C, ____CueId) == 0x000248, "Member 'UBP_TeleControlConfig_C::____CueId' has a wrong offset!");
