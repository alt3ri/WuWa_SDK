...
public:
	...
	struct FSSettlementCamera                     结算镜头;                                          // 0x0858(0x01C0)(Edit, BlueprintVisible, DisableEditOnInstance, HasGetValueTypeHash)
	TMap<EFightCameraGravity, float>              镜头重力;                                          // 0x0A18(0x0050)(Edit, BlueprintVisible, DisableEditOnInstance)
	TMap<EFightCameraGravity, struct FSBaseCurve> 镜头重力曲线配置;                                  // 0x0A68(0x0050)(Edit, BlueprintVisible, DisableEditOnInstance)
