...
public:
	...
	class UAbpLogicParams*                        LogicParams;                                       // 0x0740(0x0008)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class AKuroBaseVehicle*                       BaseVehicle;                                       // 0x0748(0x0008)(BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	uint8                                         Pad_775[0xF];                                      // 0x0775(0x000F)(Fixing Size After Last Property [ Dumper-7 ])
	struct FVector                                Acceleration;                                      // 0x0784(0x000C)(BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                                ActorForward;                                      // 0x0790(0x000C)(BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UKuroAnimInstanceVehicle) == 0x0007A0, "Wrong size on UKuroAnimInstanceVehicle");
static_assert(offsetof(UKuroAnimInstanceVehicle, LogicParams) == 0x000740, "Member 'UKuroAnimInstanceVehicle::LogicParams' has a wrong offset!");
static_assert(offsetof(UKuroAnimInstanceVehicle, BaseVehicle) == 0x000748, "Member 'UKuroAnimInstanceVehicle::BaseVehicle' has a wrong offset!");
static_assert(offsetof(UKuroAnimInstanceVehicle, DeltaTime) == 0x000750, "Member 'UKuroAnimInstanceVehicle::DeltaTime' has a wrong offset!");
static_assert(offsetof(UKuroAnimInstanceVehicle, EntityId) == 0x000754, "Member 'UKuroAnimInstanceVehicle::EntityId' has a wrong offset!");
static_assert(offsetof(UKuroAnimInstanceVehicle, bIsAutonomousProxy) == 0x000758, "Member 'UKuroAnimInstanceVehicle::bIsAutonomousProxy' has a wrong offset!");
static_assert(offsetof(UKuroAnimInstanceVehicle, Velocity) == 0x00075C, "Member 'UKuroAnimInstanceVehicle::Velocity' has a wrong offset!");
static_assert(offsetof(UKuroAnimInstanceVehicle, bIsMovedLocation) == 0x000774, "Member 'UKuroAnimInstanceVehicle::bIsMovedLocation' has a wrong offset!");
static_assert(offsetof(UKuroAnimInstanceVehicle, Acceleration) == 0x000784, "Member 'UKuroAnimInstanceVehicle::Acceleration' has a wrong offset!");
static_assert(offsetof(UKuroAnimInstanceVehicle, ActorForward) == 0x000790, "Member 'UKuroAnimInstanceVehicle::ActorForward' has a wrong offset!");
...
public:
	...
	FMulticastInlineDelegateProperty_             VehicleMovementModeChangedDelegate;                // 0x0688(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnVehicleMovementUpdated;                          // 0x0698(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
public:
	...
	float                                         MaxSafeWaterGravityAngle;                          // 0x022C(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         RotPitchFrictionRatio;                             // 0x0230(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         MaxRotationPitchAcceleration;                      // 0x0234(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         WaterDepth;                                        // 0x0238(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                                WaterNormal;                                       // 0x023C(0x000C)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         bOrientRotationToMovement : 1;                     // 0x0248(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bUseControllerDesiredRotation : 1;                 // 0x0248(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_249[0x3];                                      // 0x0249(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FRotator                               RotationRate;                                      // 0x024C(0x000C)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	struct FVector                                Acceleration;                                      // 0x0258(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	...
	uint8                                         Pad_2CC[0xB0];                                     // 0x02CC(0x00B0)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         MaxSimulationTimeStep;                             // 0x037C(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         MaxSimulationIterations;                           // 0x0380(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         MaxSimulationRotationIterations;                   // 0x0384(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         MaxDepenetrationWithGeometry;                      // 0x0388(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         MaxDepenetrationWithGeometryAsProxy;               // 0x038C(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         MaxDepenetrationWithPawn;                          // 0x0390(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         MaxDepenetrationWithPawnAsProxy;                   // 0x0394(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_398[0x10];                                     // 0x0398(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	struct FVehicleRootMotionSourceGroup          CurrentRootMotion;                                 // 0x03A8(0x0038)(Transient, NativeAccessSpecifierPublic)
	struct FRootMotionMovementParams              RootMotionParams;                                  // 0x03E0(0x0040)(Transient, NoDestructor, NativeAccessSpecifierPublic)
	struct FVector                                AnimRootMotionVelocity;                            // 0x0420(0x000C)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_42C[0x24];                                     // 0x042C(0x0024)(Fixing Size After Last Property [ Dumper-7 ])
	uint8                                         bDeferUpdateMoveComponent : 1;                     // 0x0450(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_451[0x7];                                      // 0x0451(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class USceneComponent*                        DeferredUpdatedMoveComponent;                      // 0x0458(0x0008)(ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bForbiddenTickPose;                                // 0x0460(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         bMovementInProgress : 1;                           // 0x0461(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected))
...
static_assert(sizeof(UKuroVehicleMovementComponent) == 0x000470, "Wrong size on UKuroVehicleMovementComponent");
...
static_assert(offsetof(UKuroVehicleMovementComponent, MaxSafeWaterGravityAngle) == 0x00022C, "Member 'UKuroVehicleMovementComponent::MaxSafeWaterGravityAngle' has a wrong offset!");
static_assert(offsetof(UKuroVehicleMovementComponent, RotPitchFrictionRatio) == 0x000230, "Member 'UKuroVehicleMovementComponent::RotPitchFrictionRatio' has a wrong offset!");
static_assert(offsetof(UKuroVehicleMovementComponent, MaxRotationPitchAcceleration) == 0x000234, "Member 'UKuroVehicleMovementComponent::MaxRotationPitchAcceleration' has a wrong offset!");
static_assert(offsetof(UKuroVehicleMovementComponent, WaterDepth) == 0x000238, "Member 'UKuroVehicleMovementComponent::WaterDepth' has a wrong offset!");
static_assert(offsetof(UKuroVehicleMovementComponent, WaterNormal) == 0x00023C, "Member 'UKuroVehicleMovementComponent::WaterNormal' has a wrong offset!");
static_assert(offsetof(UKuroVehicleMovementComponent, RotationRate) == 0x00024C, "Member 'UKuroVehicleMovementComponent::RotationRate' has a wrong offset!");
static_assert(offsetof(UKuroVehicleMovementComponent, Acceleration) == 0x000258, "Member 'UKuroVehicleMovementComponent::Acceleration' has a wrong offset!");
...
static_assert(offsetof(UKuroVehicleMovementComponent, MaxSimulationTimeStep) == 0x00037C, "Member 'UKuroVehicleMovementComponent::MaxSimulationTimeStep' has a wrong offset!");
static_assert(offsetof(UKuroVehicleMovementComponent, MaxSimulationIterations) == 0x000380, "Member 'UKuroVehicleMovementComponent::MaxSimulationIterations' has a wrong offset!");
static_assert(offsetof(UKuroVehicleMovementComponent, MaxSimulationRotationIterations) == 0x000384, "Member 'UKuroVehicleMovementComponent::MaxSimulationRotationIterations' has a wrong offset!");
static_assert(offsetof(UKuroVehicleMovementComponent, MaxDepenetrationWithGeometry) == 0x000388, "Member 'UKuroVehicleMovementComponent::MaxDepenetrationWithGeometry' has a wrong offset!");
static_assert(offsetof(UKuroVehicleMovementComponent, MaxDepenetrationWithGeometryAsProxy) == 0x00038C, "Member 'UKuroVehicleMovementComponent::MaxDepenetrationWithGeometryAsProxy' has a wrong offset!");
static_assert(offsetof(UKuroVehicleMovementComponent, MaxDepenetrationWithPawn) == 0x000390, "Member 'UKuroVehicleMovementComponent::MaxDepenetrationWithPawn' has a wrong offset!");
static_assert(offsetof(UKuroVehicleMovementComponent, MaxDepenetrationWithPawnAsProxy) == 0x000394, "Member 'UKuroVehicleMovementComponent::MaxDepenetrationWithPawnAsProxy' has a wrong offset!");
static_assert(offsetof(UKuroVehicleMovementComponent, CurrentRootMotion) == 0x0003A8, "Member 'UKuroVehicleMovementComponent::CurrentRootMotion' has a wrong offset!");
static_assert(offsetof(UKuroVehicleMovementComponent, RootMotionParams) == 0x0003E0, "Member 'UKuroVehicleMovementComponent::RootMotionParams' has a wrong offset!");
static_assert(offsetof(UKuroVehicleMovementComponent, AnimRootMotionVelocity) == 0x000420, "Member 'UKuroVehicleMovementComponent::AnimRootMotionVelocity' has a wrong offset!");
static_assert(offsetof(UKuroVehicleMovementComponent, DeferredUpdatedMoveComponent) == 0x000458, "Member 'UKuroVehicleMovementComponent::DeferredUpdatedMoveComponent' has a wrong offset!");
static_assert(offsetof(UKuroVehicleMovementComponent, bForbiddenTickPose) == 0x000460, "Member 'UKuroVehicleMovementComponent::bForbiddenTickPose' has a wrong offset!");
