...
// const TDelegate<void(bool Result, class UTraceBaseElement* Element, double Frame, double Index_0)>&Delegate                                               (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, NativeAccessSpecifierPublic)
...
void UKuroTraceLibrary::AsyncBoxTrace(class UTraceBoxElement* Element, const class FString& ProfileKey, const TDelegate<void(bool Result, class UTraceBaseElement* Element, double Frame, double Index_0)>& Delegate, const double Frame, const double Index_0)
{
	static class UFunction* Func = nullptr;
...
void UKuroTraceLibrary::AsyncCapsuleTrace(class UTraceCapsuleElement* Element, const class FString& ProfileKey, const TDelegate<void(bool Result, class UTraceBaseElement* Element, double Frame, double Index_0)>& Delegate, const double Frame, const double Index_0)
{
	static class UFunction* Func = nullptr;
...
void UKuroTraceLibrary::AsyncLineTrace(class UTraceLineElement* Element, const class FString& ProfileKey, const TDelegate<void(bool Result, class UTraceBaseElement* Element, double Frame, double Index_0)>& Delegate, const double Frame, const double Index_0)
{
	static class UFunction* Func = nullptr;
...
void UKuroTraceLibrary::AsyncSphereTrace(class UTraceSphereElement* Element, const class FString& ProfileKey, const TDelegate<void(bool Result, class UTraceBaseElement* Element, double Frame, double Index_0)>& Delegate, const double Frame, const double Index_0)
{
	static class UFunction* Func = nullptr;
