...
// Function CableComponent.CableComponent.ResetMiddleParticles
// (Final, Native, Public, BlueprintCallable)

void UCableComponent::ResetMiddleParticles()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("CableComponent", "ResetMiddleParticles");
...
// Function CableComponent.CableComponent.D_GetCableParticleLocations
// (Final, Native, Public, HasOutParams, BlueprintCallable, BlueprintPure, Const)
// Parameters:
// TArray<struct FVectorDouble>*           Locations                                              (Parm, OutParm, ZeroConstructor, NativeAccessSpecifierPublic)

void UCableComponent::D_GetCableParticleLocations(TArray<struct FVectorDouble>* Locations) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("CableComponent", "D_GetCableParticleLocations");

	Params::CableComponent_D_GetCableParticleLocations Parms{};
