...
// Function BP_VolumetricFogDistFalloff_RectLight.BP_VolumetricFogDistFalloff_RectLight_C.GetPlacementSortOrder
// (Event, Public, HasOutParams, BlueprintCallable, BlueprintEvent, BlueprintPure, Const)
// Parameters:
// int32                                   ReturnValue                                            (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

int32 ABP_VolumetricFogDistFalloff_RectLight_C::GetPlacementSortOrder() const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_VolumetricFogDistFalloff_RectLight_C", "GetPlacementSortOrder");

	Params::BP_VolumetricFogDistFalloff_RectLight_C_GetPlacementSortOrder Parms{};
