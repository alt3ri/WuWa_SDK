...
public:
	...
	TMulticastInlineDelegate<void(int32 Index_0)> OnArrivePointCallback;                             // 0x0288(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
