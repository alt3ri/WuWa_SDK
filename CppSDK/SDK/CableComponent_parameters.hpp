...
struct CableComponent_D_GetCableParticleLocations final
{
public:
	TArray<struct FVectorDouble>                  Locations;                                         // 0x0000(0x0010)(Parm, OutParm, ZeroConstructor, NativeAccessSpecifierPublic)
};
DUMPER7_ASSERTS_CableComponent_D_GetCableParticleLocations;
