...
// (Public, HasOutParams, BlueprintCallable, BlueprintEvent)
// Parameters:
// EAiLevelVarSource                       Sa______                                               (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class FString                           Sa____                                                 (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, HasGetValueTypeHash)
// int32                                   Sao_L__id                                              (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// TDelegate<void(bool bContent)>          __                                                     (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ZeroConstructor, ReferenceParm)

void AAIC_AICommon_C::__sa___b__(EAiLevelVarSource Sa______, const class FString& Sa____, int32 Sao_L__id, const TDelegate<void(bool bContent)>& __)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("AIC_AICommon_C", "(saØÏbÑ,");

	Params::AIC_AICommon_C___sa___b__ Parms{};

	Parms.Sa______ = Sa______;
	Parms.Sa____ = std::move(Sa____);
	Parms.Sao_L__id = Sao_L__id;
	Parms.__ = __;
