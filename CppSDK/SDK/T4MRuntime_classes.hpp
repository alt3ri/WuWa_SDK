...
public:
	...
	class UTexture2D*                             KuroColormapTexture;                               // 0x0648(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, TextExportTransient, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<struct FVector4>                       LandscapeLayerParams;                              // 0x0650(0x0010)(ZeroConstructor, TextExportTransient, NativeAccessSpecifierPublic)
	TArray<class UMaterialInstanceConstant*>      MaterialInstances;                                 // 0x0660(0x0010)(ZeroConstructor, TextExportTransient, NativeAccessSpecifierPrivate)
...
static_assert(offsetof(UT4MLandscapeComponent, KuroColormapTexture) == 0x000648, "Member 'UT4MLandscapeComponent::KuroColormapTexture' has a wrong offset!");
static_assert(offsetof(UT4MLandscapeComponent, LandscapeLayerParams) == 0x000650, "Member 'UT4MLandscapeComponent::LandscapeLayerParams' has a wrong offset!");
static_assert(offsetof(UT4MLandscapeComponent, MaterialInstances) == 0x000660, "Member 'UT4MLandscapeComponent::MaterialInstances' has a wrong offset!");
