...
public:
	...
	bool                                          CallFunc_Less_IntInt_ReturnValue;                  // 0x0058(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_59[0x7];                                       // 0x0059(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FSCameraConfig                         CallFunc_GetDataTableRowFromName_OutRow;           // 0x0060(0x0838)(HasGetValueTypeHash)
	...
	int32                                         CallFunc_Array_Add_ReturnValue;                    // 0x089C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
