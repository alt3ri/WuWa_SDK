...
{
public:
	struct FDestructibleParameters                DefaultDestructibleParameters;                     // 0x0480(0x0088)(Edit, NativeAccessSpecifierPublic)
	TArray<struct FFractureEffect>                FractureEffects;                                   // 0x0508(0x0010)(Edit, EditFixedSize, ZeroConstructor, NativeAccessSpecifierPublic)
	class UStaticMesh*                            StaticMeshProxy;                                   // 0x0518(0x0008)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UDestructibleMesh) == 0x000528, "Wrong size on UDestructibleMesh");
static_assert(offsetof(UDestructibleMesh, DefaultDestructibleParameters) == 0x000480, "Member 'UDestructibleMesh::DefaultDestructibleParameters' has a wrong offset!");
static_assert(offsetof(UDestructibleMesh, FractureEffects) == 0x000508, "Member 'UDestructibleMesh::FractureEffects' has a wrong offset!");
static_assert(offsetof(UDestructibleMesh, StaticMeshProxy) == 0x000518, "Member 'UDestructibleMesh::StaticMeshProxy' has a wrong offset!");
