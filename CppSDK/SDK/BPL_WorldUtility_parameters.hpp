...
public:
	...
	bool                                          Exist;                                             // 0x0018(0x0001)(Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_19[0x7];                                       // 0x0019(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FSModelConfig                          Out_Row;                                           // 0x0020(0x0448)(Parm, OutParm, ContainsInstancedReference, HasGetValueTypeHash)
	struct FSModelConfig                          CallFunc_GetDataTableRowFromName_OutRow;           // 0x0468(0x0448)(ContainsInstancedReference, HasGetValueTypeHash)
...
static_assert(sizeof(BPL_WorldUtility_C_GetModelTableByName) == 0x0008B8, "Wrong size on BPL_WorldUtility_C_GetModelTableByName");
...
static_assert(offsetof(BPL_WorldUtility_C_GetModelTableByName, CallFunc_GetDataTableRowFromName_OutRow) == 0x000468, "Member 'BPL_WorldUtility_C_GetModelTableByName::CallFunc_GetDataTableRowFromName_OutRow' has a wrong offset!");
static_assert(offsetof(BPL_WorldUtility_C_GetModelTableByName, CallFunc_GetDataTableRowFromName_ReturnValue) == 0x0008B0, "Member 'BPL_WorldUtility_C_GetModelTableByName::CallFunc_GetDataTableRowFromName_ReturnValue' has a wrong offset!");
